...
if(move_uploaded_file($_FILES['photo']['tmp_name'],'../images/'.$url_img)){
   require '../config/database.php';
            ...
            $req=$db->prepare('UPDATE `eleve` SET `nom`=:nom,`postnom`=:postnom,`prenom`=:prenom,`sexe`=:sexe,`datenassance`=:datenassance,`lieunaiss`=:lieunaiss,`province`=:province,`territoire`=:territoire,`nationalite`=:nationalite,`avenue`=:avenue,`quartier`=:quartier,`commune`=:commune,`ville`=:ville,`tutaire`=:tutaire,`professiontutaire`=:professiontutaire,`contact`=:contact,`photo`=:photo WHERE `ideleve`=:ideleve');
            $req->execute(array(
...
return true;
        ...
        $req=$db->prepare('UPDATE `eleve` SET `nom`=:nom,`postnom`=:postnom,`prenom`=:prenom,`sexe`=:sexe,`datenassance`=:datenassance,`lieunaiss`=:lieunaiss,`province`=:province,`territoire`=:territoire,`nationalite`=:nationalite,`avenue`=:avenue,`quartier`=:quartier,`commune`=:commune,`ville`=:ville,`tutaire`=:tutaire,`professiontutaire`=:professiontutaire,`contact`=:contact WHERE `ideleve`=:ideleve');
        $req->execute(array(
        'nom' => $nom,            
        'postnom' => $postnom,            
        'prenom' => $prenom,            
