...
if(move_uploaded_file($_FILES['logo']['tmp_name'],'../images/'.$url_img)){
   require '../config/database.php';
            ...
            $req=$db->prepare('UPDATE `ecole` SET `nom`=:nom,`responsable`=:responsable,`telephone`=:telephone,`email`=:email,`adresse`=:adresse,`logo`=:logo WHERE `idecole`=:idecole');
            $req->execute(array(
...
return true;
        ...
        require '../config/database.php';
            ...
            $req=$db->prepare('UPDATE `ecole` SET `nom`=:nom,`responsable`=:responsable,`telephone`=:telephone,`email`=:email,`adresse`=:adresse WHERE `idecole`=:idecole');
            $req->execute(array(
            'nom' => $nom,            
            'responsable' => $responsable,            
            'telephone' => $telephone,            
