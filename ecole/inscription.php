                                                    ...
                                                    <input type="hidden" name="idins" id="idins" value="<?=$lig->idins ;?>" class="form-control" required/>
                                                        <div class="row">
                                                            <div class="col-md-12 mt-3">
                                                                <div class="form-group">
                                                                    <label for="ideleve">Choisir l'eleve</label>
                                                                    <select  class="form-control" name='ideleve' value="<?=$lig->ideleve ;?>" required >
                                                                        <option value="<?=$lig->ideleve ;?>"><?=$lig->ideleve ;?></option> 
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="idclass">Choisir la classe</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="annee">Entré l'année</label>
                                                                    <input type="text" class="form-control" placeholder="Entré l'année" value="<?=$lig->annee ;?>" name='annee' required />
                                                                </div>                                                                                               
                                                            </div>                                                               
                                                            <div class="form-group">                               
